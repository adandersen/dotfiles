...
(global-auto-revert-mode)      ; auto-sync files when modified on disk
(winner-mode)                  ; restore previous window arrangements and buffer contents of those windows
(electric-pair-mode)           ; auto parentheses pairing
(show-paren-mode)              ; highlight pairing parentheses with cursor
...
(use-package evil :ensure t
  ...
  :config
  (evil-mode 1)
  (setq-default evil-escape-delay 0.2)) ; evil config guide -- https://github.com/noctuid/evil-guide

;; set sane defaults in other modes that aren't evilified
(use-package evil-collection :ensure t
  :after evil
  :config
  (evil-collection-init)) ; i don't know how useful this is yet. `evil-collection-mode-list' to see list of affected modes
