...
values."
  (setq-default
   ;; Base distribution to use. This is a layer d in the directory
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-scratch-mode 'javascript-mode
